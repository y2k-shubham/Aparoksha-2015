...
public class Roboticsevents extends Activity {
	...
	static {
		if (catRobotics == null) {
			...
			catRobotics[0] = new Contact("AI Pod", "20-Mar\t\t04:00 pm",
					R.drawable.ai_pod);
		...
		if (catElectronics == null) {
			...
			catElectronics[0] = new Contact("Riddlonics", "18-Mar\t\t07:00 pm",
					R.drawable.riddlonics);
			catElectronics[1] = new Contact("Techno Fault",
					"18-Mar\t\t07:00 pm", R.drawable.techno_fault);
			catElectronics[2] = new Contact("Black Box", "20-Mar\t\t12:00 am",
		...
		if (catNetworking == null) {
			...
			catNetworking[0] = new Contact("Perplexus", "20-Mar\t\tAll Day",
					R.drawable.perplexus);
			catNetworking[1] = new Contact("Platzen", "21-Mar\t\tAll Day",
					R.drawable.platzen);
			catNetworking[2] = new Contact("Cold Fire", "21-Mar\t\t09:00 am",
		...
		if (catDevelopment == null) {
			...
			catDevelopment[0] = new Contact("Webkriti", "18-Mar\t\t06:00 pm",
					R.drawable.webkriti);
			catDevelopment[1] = new Contact("Eureka", "18-Mar\t\t11:59 pm",
					R.drawable.eureka);
			catDevelopment[2] = new Contact("V Flare", "18-Mar\t\t11:59 pm",
					R.drawable.v_flare);
		...
		if (catMisc == null) {
			...
			catMisc[0] = new Contact("Biomeda", "", R.drawable.biomeda);
			...
			catMisc[5] = new Contact("Tech Talks", "21-Mar\t\t08:00 pm",
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		mListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(final AdapterView<?> parent,
				...
				Intent i = new Intent("com.carouseldemo.main.events");
